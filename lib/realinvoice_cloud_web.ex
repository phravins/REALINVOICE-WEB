defmodule RealinvoiceCloudWeb do
  @moduledoc """
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # SaladUI component library (button, input, card, table, sidebar, ...)
      use SaladUI
      ...
      alias RealinvoiceCloudWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: RealinvoiceCloudWeb.Router,
        statics: RealinvoiceCloudWeb.static_paths()
    end
  end
