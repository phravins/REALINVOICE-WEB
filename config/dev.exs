...
config :realinvoice_cloud, RealinvoiceCloudWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "h43KyqTAyrJvqRWAbeFpsHNpDfcdHgBxvqe4DWYCBBaV2ipm3tTcz4mMnzyi2SMa",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:realinvoice_cloud, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:realinvoice_cloud, ~w(--watch)]}
  ]
...
config :realinvoice_cloud, dev_routes: true
